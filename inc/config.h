...
#define FONT_DIGIT_0 {14, 17, 3, 21, 25, 17, 17, 14}
#define FONT_DIGIT_1 {4, 12, 20, 4, 4, 4, 4, 31}
#define FONT_DIGIT_2 {14, 17, 1, 2, 4, 8, 16, 31}
#define FONT_DIGIT_3 {14, 17, 1, 6, 1, 1, 17, 14}
#define FONT_DIGIT_4 {17, 17, 17, 31, 1, 1, 1, 1}
#define FONT_DIGIT_5 {31, 16, 16, 30, 1, 1, 1, 30}
#define FONT_DIGIT_6 {15, 16, 16, 31, 17, 17, 17, 14}
#define FONT_DIGIT_7 {31, 1, 1, 2, 8, 8, 8, 8}
#define FONT_DIGIT_8 {14, 17, 17, 14, 17, 17, 17, 14}
#define FONT_DIGIT_9 {14, 17, 17, 31, 1, 1, 17, 14}
